 ...
 */
import { CORS_PROXY_URL, DEFAULT_MAX_SIZE_KB, LIGHTWEIGHT_THRESHOLD_KB, COMPRESSION_MODES } from "./constants.js";
import {
    fetchImageMetadata,
    compressImage,
    insertImageBelow,
        ...
        return await withPreservedScroll(null, async () => {
            try {
                ...
                if (strategy === "batch" && selectedImages.length > 1) {
                    // Step 2A: Quick Batch Configuration Dialog
                    ...
                    // Step 2B: Step-by-Step Individual Configuration Dialogs (or Fast-Track Single Selected)
