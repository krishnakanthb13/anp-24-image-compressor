 ...
 * @description Amplenote noteOption handler with guided 2-step wizard, batch vs step-by-step workflows, fast-track single selection, surgical in-place replacement, and non-destructive report exports.
 */
    ...
    run: async function(app, noteUUID) {
        ...
        return await withPreservedScroll(null, async () => {
            try {
                ...
                // Handle creation of non-destructive report note if newNoteItems were collected
